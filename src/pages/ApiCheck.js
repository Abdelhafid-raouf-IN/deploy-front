...
<div 
  className="mb-4 text-white p-6 rounded-lg shadow-lg text-center border border-blue-700"style={{background: '#280257',background: 'linear-gradient(180deg, #280257, #140131)',}}>        <div className="flex items-center justify-center mb-4">
